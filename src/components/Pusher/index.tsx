...
//   PusherEvent,
//   PusherAuthorizerResult,
// } from './connected'; // This links the example app to the current SDK implementation

export default function ConnectChannel() {
  let logLines: string[] = [];
  const pusher = Pusher.getInstance();

  const [apiKey, onChangeApiKey] = React.useState('a5d510a5fdd307052416');
  const [cluster, onChangeCluster] = React.useState('ap1');
